      ...
      <div class = "container-expand-md text-center">
         <div class = "row">
            ...
            <div class = "col-sm-4 text-left" style = "margin-top:20px;padding: 10px; line-height: 1.68;">
               <h4 class="text-large text-bold"><i class="wc-l-help wc-green"></i>&nbsp;QUESTION GUIDELINES</h4>
               <p>Include a title to your question and a more detailed description. The more unique and informative your question, the better the chance you have of tutors engaging with you.</p>
