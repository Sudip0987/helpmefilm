...
<html lang="en">
  ...
  <script src="https://use.fontawesome.com/4c8273f771.js"></script>
    ...
    <body  onload = "loadAllData('<?php echo $_SESSION['userID']; ?>');" >
                        ...
                        <div class="profile-img" style='height: 230px;' >
                            ...
                            <div id = "imageSpinner">
                                ...
                                <?php 
                                  ...
                                  echo $_SESSION['email'];
                                  ?>
                                <input type="file" name="file" onchange="uploadPicture(event)" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="profile-head">
                                ...
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class='nav-item'>
                                      <a class='nav-link ' data-toggle='tab'  href='#resume'>Resume</a> <!--sss -->
                                    </li>
                                </ul>
...
" id = "btAddSkills" onClick="addSkills(document.getElementById('textSkills').value,document.getElementById('userID').value)">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                              ...
                                              <input type="button" hidden id = "editDetails">
                                                <label for="editDetails"  ><span class="fa fa-pencil"></span> </label >
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-5">
                                        ...
                                        <div class = "row" style='margin-top:20px'>
                                          ...
                                          <div class = "col-md-2">
                                             <input type="button" hidden id = "editBio" onClick="editBio(document.getElementById('bioLabel').innerHTML)">
                                                <label for="editBio"  ><span class="fa fa-pencil"></span> </label >
                                          </div>
                                        </div>
                                        <div class = "row" >
                                ...
                                <div class = "row" style = "margin-bottom:20px;">
                                  ...
                                  <div class = "col-md-3 text-right" id = "divSpinner" >
                                   ...
                                   <div class = "col-md-2">
                                    ...
                                    <input type="file" onchange ="uploadResume(event)"  hidden id = "btAddFile">
                                      <label for="btAddFile"  ><span class="fa fa-pencil"></span> </label >
                                  </div>
                                </div>
    ...
    background-color: transparent;border-color:rgba(255,255,255,0.2);' data-target="#myModal">Add New Role</button>
