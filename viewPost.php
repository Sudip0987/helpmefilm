...
$totalReplies="";
$searchFilters="";
$sql = "Select * from Topic t,Users u where u.userID=t.posterID  and postType= 'question' order by pdate desc;";
$wordCollection="";
if(isset($_GET['searchTopic'])){
  ...
  $searchSql="Select *, topic,count(topic) as matches from users u,topic tc,TopicTags tt,Tags t where tc.posterID=u.userID and tc.topicID=tt.topicID and tt.tagID=t.tagID and postType='question' and (". $searchFilters." ) group by topic order by matches desc;";
  $sql=$searchSql;
}
...
//$sql = "SELECT t.topicID,topic,topicDesc,pdate,email,name, count(replyID)as totalReplies from Topic t, Users u, Replies r WHERE t.posterID=u.userID and t.topicID = r.topicID;";
  ...
  <div class='row justify-content-center style='margin-bottom:10px;'>
                        <div class='col-12 col-md-12 col-lg-12'>
                            <form class='card card-sm' action='viewPost.php'  method='GET'>
...
$tagDb=$db;
 ...
 <div class = 'row justify-content-center ' style='margin-top:25px; '>
  ...
  if(isset($_SESSION['userID'])){
    ...
    $sql = "Select * from Topic t,Users u where u.userID=t.posterID  and postType= 'question' and userID=".$tempID." order by pdate;";
