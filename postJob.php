      ...
      <div class = "container-expand-md text-center">
         <div class = "row">
                     ...
                     <form method = "post" id= "topicForm" action = "topicPage.php" style="padding: 20px;">
                        ...
                        <div class = "row" style= "padding-top: 20px;">
                           <div class = "col">
                              ...
                              <div class = "row">
                                 <div class = "col col text-left">
                                    <input type = "text" value = '<?php echo $tags; ?>' class = "form-control" name = "location" id = "tags"/>
                                 </div>
                              </div>
                           </div>
                        </div>
            ...
            <div class = "col-sm-4 text-left" style = "margin-top:20px;padding: 10px; line-height: 1.68;">
               <h4 class="text-large text-bold"><i class="wc-l-help wc-green"></i>&nbsp;POST GUIDELINES</h4>
               <p>Include a title to your Post and a more detailed description. The more unique and informative your Post, the better the chance you have of users engaging with you.</p>
               <h5 class="text-caps spc-n">Posts</h5>
               <ul>
                  <li>Include a title to your Post and a more detailed description. The more unique and man.</li>
                  <li>Include a title to your Post and a more detailed description. The more unique and man.</li>
                  <li>Include a title to your Post and a more detailed description. The more unique and man.</li>
               </ul>
               <p>We’ll notify you by email whenever a tutor answers your Post or when you receive comments for more clarification</p>
               <hr>
               <p>Remember to follow the <a class="honesty-policy-link wyzantModal" href="#">Helpmefilm</a> policy when composing your Post.</p>
            </div>
         </div>
      </div>
   </body>
